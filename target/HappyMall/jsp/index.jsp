...
<div class="agileits_header">
    <div class="container">
        <div class="w3l_offers">
            <p> &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;欢迎来到Happy Mall. <a href="#">SHOP NOW</a></p>
        </div>
        ...
        <div class="product_list_header">
            <form action="/cart/checkout.action" method="post" class="last">
                                                ...
                                                <figure>
                                                    <div class="snipcart-item block" >
                                                        ...
                                                        <div class="snipcart-details top_brand_home_details">
                                                            <input type="button" onclick="mycart(${goods.id})" name="button"  value="加入购物车" class="button" />
                                                        </div>
                                                    </div>
                                                </figure>
                                            </div>
        ...
        $.ajax({
            ...
            success:function (info) {
                layui.use('layer',function () {
                   if($("#idList").val().toString().indexOf(id)==-1)
