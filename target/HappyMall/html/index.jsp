...
<head>
    ...
    <script src="/js/jquery-form-js.js"></script>
    <!-- //js -->
...
<div class="agileits_header">
    <div class="container">
        <div class="w3l_offers">
            <p> &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;欢迎来到Happy Mall. <a href="products.html">SHOP NOW</a></p>
        </div>
...
<div class="logo_products">
    <div class="container">
        ...
        <div class="w3ls_logo_products_left" >
            <h1><a href="#">Happy Mall</a></h1>
        </div>
        <div class="w3l_search">
            <form action="#" method="post">
                <input type="search" name="Search" placeholder="搜索商品" required="true">
        ...
        <nav class="navbar navbar-default">
            ...
            <div class="collapse navbar-collapse" id="bs-megadropdown-tabs">
                <ul class="nav navbar-nav">
                    <li class="active"><a href="/HappyMall/index.action" class="act">主页</a></li>
                    <!-- Mega Menu -->
                    <li class="dropdown"><a href="#" class="dropdown-toggle" data-toggle="dropdown">Groceries<strong class="caret"></strong></a>
                    ...
                    <li class="dropdown"><a href="#" class="dropdown-toggle" data-toggle="dropdown">Household<strong class="caret"></strong></a>
                        <ul class="dropdown-menu multi-column columns-3">
                            <div class="row">
                                <div class="multi-gd-img">
                                    <ul class="multi-column-dropdown">
...
<!-- top-brands -->
<div class="tlinks">Collect from <a href="#"  title="网站模板">网站模板</a></div>
                                            ...
                                            <figure>
                                                <div class="snipcart-item block" >
                                                    <div class="snipcart-thumb">
                                                        <a href="#"><img style="width: 350px;height: 400px" title=" " alt=" " src="${goods.goodsImage}" /></a>
                                                        <p>${goods.goodsName}</p>
                                                        <div class="stars">
                                                    ...
                                                    <div class="snipcart-details top_brand_home_details">
                                                        <form  action="/cart/cart.action" name="cart" >
                                                            <fieldset>
                                                                ...
                                                                <input type="button" onclick="mycart()" name="button"  value="加入购物车" class="button" />
                                                            </fieldset>
                                                        </form>
                                                    </div>
                                                </div>
...
<script src="/layui-v2.4.5/layui/layui.js"/>
<!-- main slider-banner -->
